...
<link rel="canonical" href="https://goo.gl/maps/M1s318teEZxjUdqbA">
        ...
        <link rel="shortcurt icon" href="{{ asset('ancaju_logo.svg') }}">
        {{--  --}}
...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Merienda:wght@300..900&family=Oswald:wght@200..700&family=Playwrite+US+Trad:wght@100..400&display=swap" rel="stylesheet">
    ...
    font-weight: ;
    font-style: normal;'>
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen r bg-center  selection:text-white ">
            {{-- @if (Route::has('login'))
            ...
            <div class="pb-12 flex flex-col gap-4">
                <x-wel-navmenu/>
                    <div class="md:max-w-7xl w-[100vw] mx-auto sm:px-6 lg:px-8">
                        <div id="ancajuHome"  class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                            <x-welcome />
                        </div>
                    </div> 
