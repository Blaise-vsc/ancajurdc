...
<body class="parent ">
   ...
   @livewire('sentmessage')

    {{-- <div class="flex flex-row md:flex-col items-center md:justify-center justify-between  w-full md:w-[40px] botton-[0%] md:top-[25%] left-[0%] md:left-[2%] md:h-[40%] py-2 px-4 border-2 border-gray-400 rounded-[8px] bg-gray-300 hover:bg-gray-300 fixed">
        <button title="home" class="h-[25%] border-b border-t border-gray-100" onclick="window.print()"><i class='bx bx-home'></i></button>
      <button title="print pdf" class="h-[25%] border-b border-gray-100" onclick="window.print()"><i class='bx bx-download'></i></button>
      <button title="conversation" class="h-[25%] border-b border-gray-100" onclick="window.print()"><i class='bx bx-conversation'></i></button>
      <button class="h-[25%] border-b border-gray-100" onclick="window.print()"><i class='bx bxs-contact' ></i></button>
    </div> --}}
